...
*/
--sy0
insert into orders(o_no, o_name, o_desc, o_date, o_price, o_address, o_loc, o_payment, m_id) values(orders_o_no_SEQ.nextval, '김세영','o_desc', sysdate, 80000, '서울시 강남구','문 앞에 놔주세요', 'o_payment', 'sy0');
...
--sy1
insert into orders(o_no, o_name, o_desc, o_date, o_price, o_address, o_loc, o_payment, m_id) values(orders_o_no_SEQ.nextval,'김민선', 'o_desc', sysdate, 90000, '서울시 강남구','벨 울리지 말아주세요', 'o_payment', 'sy1');
