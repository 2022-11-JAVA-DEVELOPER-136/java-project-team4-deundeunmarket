...
insert into product(p_no, p_name, p_price, p_image, p_desc) values(product_p_no_SEQ.nextval, '우동', 10000, '/images/우동_작은.jpg', '집에서 맛보는 인기 메뉴');
...
*/
--sy0
insert into orders(o_no, o_name, o_desc, o_date, o_price, o_address, o_loc, o_payment, m_id) values(orders_o_no_SEQ.nextval, '김세영', '닭도리탕 외 1종', sysdate, 80000, '서울시 강남구','문 앞에 놔주세요', '계좌이체', 'sy0');
...
--sy1
insert into orders(o_no, o_name, o_desc, o_date, o_price, o_address, o_loc, o_payment, m_id) values(orders_o_no_SEQ.nextval, '김민선', '막국수 외 1종', sysdate, 90000, '서울시 강남구','벨 울리지 말아주세요', '카드결제', 'sy1');
