...
public class MemberServiceTestMain {
	...
	public static void main(String[] args) throws Exception {
		...
		boolean addSuccess1 = 
				memberService.create(new Member("aaaa", "aaaa", "서테스", "010-1234-5677", new Date(1993,01,01), "s@naver.com", "서울시 송파구"));
		...
		System.out.println(">>"+memberService.findMemberDetail("sy0"));
		
		System.out.println("6. 회원추가");
		Member nMember = new Member("sy4", "pass", "업뎃", "xxx-xxx", new Date(1993,01,02), "up@up", "업뎃");
		memberService.memberWrite(nMember);
		
		System.out.println("7. 회원정보 수정");
		Member upMember = new Member("sy0", "pass", "업뎃", "xxx-xxx", new Date(1993,01,02), "up@up", "업뎃");
		memberService.update(upMember);
		
		System.out.println("8. 회원탈퇴");
		System.out.println(">>"+memberService.remove("aaaa"));
